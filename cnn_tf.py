...
#defines the first convolutional layer with 16 filters of size 2x2, using ReLU activation function and 'same' padding.
	...
	# Dense Layer ,defining a neural network layer that takes the output tensor conv3 
